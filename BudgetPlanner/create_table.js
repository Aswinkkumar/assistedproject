...
function initialize(){
    if (localStorage.getItem("myData") ===null){
        //alert("inside if")
        myData = [new Deal(0,"Bosch","VLSI Project","Dominic",145000),
        new Deal(1,"Intel","Chip Project","Astin",150000),
        new Deal(2,"Google","web Project","RoseMary",100000)
        ]
...
function CreateTableFromJSON() {    
    ...
    <td><button onclick="DeleteRow(${value.dealId})"> <img src="delete.jpg" width="50""> </button></td>
  </tr>`);
    })
}
